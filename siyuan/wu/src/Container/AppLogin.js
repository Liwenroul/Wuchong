        ...
        return (
            <div style={{background:'#fff'}}>
                ...
                <div style={{height: '250px',background:'#fff',marginTop:-10}}>
                    ...
                    <input type='submit' onClick={this.check} style={{width:'100%',height:50,margin:'0 auto',background:'#1daea9',color:'#fff',borderRadius:'40px',fontSize:30,marginTop:20}} value='登陆'/>
