...
export default class AppWeizhi extends Component {
    ...
    handleSubmit=(event)=> {
        ...
        window.location='/fabu'+this.state.dengluId;
            ...
            <div>
                <div style={{marginTop:'2%',width:'100%',height:100}}>
                    <form  style={{marginTop:'10%'}}>
                        ...
                        <input type="button" onClick={this.handleSubmit} value="确定" style={{float:'right',width:'20%',height:40,marginRight:'10px',marginTop:2,background:'rgb(29,174,169)',color:'#fff',borderRadius:'20px'}}/>
                    </form>
                </div>
                <div style={{marginTop:'20%',width:'100%'}}>
                    <Link to={'/fabu'+this.state.dengluId}><h1 style={{marginLeft:'30%'}}> 《 默认位置 </h1></Link>
                </div>
