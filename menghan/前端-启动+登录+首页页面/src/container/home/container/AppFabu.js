...
const data = [{url:require('../../../images/photo.jpg')}];
...
export default class AppFabu extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div  style={{border:'1px solid #33cccc',color:'#33cccc',height:48,fontSize:20,textAlign:'center'}}>
                    <Link to='/tab'><i style={{float:'left',lineHeight:'40px',fontSize:30}} className='iconfont icon-icon-' /></Link>
                    {/* <Link><button style={{width:'100px',height:45,border:'1px solid #33cccc',borderRadius:'25px'}}>存草稿</button></Link> */}
                    {/* <Link> */}
                    <button onClick={()=>{window.history.back()}} style={{float:'right',width:'100px',height:45,marginRight:'10px',background:'#33cccc',color:'#fff',borderRadius:'25px'}}>发布</button>
                    {/* </Link> */}
                </div>
                <div style={{width:'100%',height:'700px',background:'#fff'}}>
                    <form >
                        ...
                        <div style={{width:'100%',height:50}}>
                            ...
                            <div style={{width:'100%',height:50,lineHeight:'40px',fontSize:20,padding:'20px 20px',borderTop:'1px solid grey'}}>
                                <button style={{float:'left',background:'#33cccc',color:'#fff',borderRadius:'10px',lineHeight:'50px'}}>河北师范大学</button>
                            </div>
                        </div>
                    </form>
                </div>
